  ...
  return (
    <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-xl font-bold text-slate-900">Daftar Rekening (Chart of Accounts)</h1>
        <button
          onClick={handleAdd}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="w-96 rounded-2xl bg-white p-6 shadow-2xl">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-semibold mb-1">Kode Rekening</label>
                <input
                  type="text"
                  disabled={!!editingId}
              ...
              <div>
                <label className="block text-sm font-semibold mb-1">Nama Rekening</label>
                <input
                  type="text"
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        tipe_normal: e.target.value as any,
                      })
                    }
                    className="w-full rounded-lg border border-slate-200 px-3 py-2"
                  >
